...
// --- FUNÇÃO DE LIMPEZA (Crucial para evitar erros de undefined no Firebase) ---
...
export const useSaveInvestment = () => {
    ...
    return useMutation({
        ...
        onSuccess: () => {
            // Invalida o cache para forçar o componente a reler os dados do banco
            queryClient.invalidateQueries({ queryKey: ['investments'] });
        },
        onError: (error) => {
            console.error("Erro na mutação de investimento:", error);
        }
    });
};
