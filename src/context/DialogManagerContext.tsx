...
type ActiveDialog = "login" | "register" | "confirm-account" | "add-finance" | "edit-finance" | "delete-finance" | "forgot-password" | "add-budget" | "confirm-dialog" | "add-investment" | null;
